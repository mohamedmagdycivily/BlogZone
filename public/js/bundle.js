...
function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "DELETE",
              url: "http://127.0.0.1:3000/api/v1/posts/".concat(e.target.dataset.indexNumber)
            });
          ...
          case 8:
            ...
            (0, _alerts.showAlert)("error", "Error Deletting this tour !");
  ...
  return function deleteTourFunc(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.deleteTourFunc = deleteTourFunc;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"createPost.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"createAcc.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  return function createAcc(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.createAcc = createAcc;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"follow.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  return function followHandler(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.followHandler = followHandler;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"FilteredTours.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.displayFilteredTours = void 0;
...
function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            console.log("data =", data); //   console.log("tours = ", tours[0]);
            //   console.log(e.target.value);
          ...
          case 5:
            res = _context.sent;
            console.log(res.body); // if ((res.data.status = "success")) {
            //   location.reload(true);
            //   // location.assign("/");
            // }
  ...
  return function displayFilteredTours(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.displayFilteredTours = displayFilteredTours;
...
var _createAcc = require("./createAcc");

var _follow = require("./follow");

var _FilteredTours = require("./FilteredTours");
...
var createPostDataForm = document.querySelector(".form-createPost-data");
var userPasswordForm = document.querySelector(".form-user-password");
var signUpForm = document.querySelector(".form-user-create");
var deleteTour = document.querySelectorAll(".clickListen");
var followButton = document.querySelector(".followButton"); // const search = document.querySelector(".searchContainer");
// const searchBarTitle = document.querySelector(".searchBarTitle");

var searchBar = document.querySelectorAll(".search__input");
var search = document.querySelector(".search"); // console.log("searchBar = ", searchBar);
// if (search) {
...
if (deleteTour) {
  deleteTour.forEach(function (a) {
    a.addEventListener("click", _deleteTour.deleteTourFunc);
  });
}
...
if (createPostDataForm) {
  createPostDataForm.addEventListener("submit", function (e) {
    e.preventDefault();
    var form = new FormData();
    form.append("title", document.getElementById("title").value);
    form.append("body", document.getElementById("body").value);
    ...
    form.append("photo", document.getElementById("image").files[0]);
    console.log("form = ", form);
    (0, _createPost.createPost)(form, "create");
  });
}
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            form.append("passwordConfirm", document.getElementById("password_confirm_create").value);
            _context2.next = 10;
...
if (followButton) {
  followButton.addEventListener("click", _follow.followHandler);
} ///////////////////////////////////////////////////////////////////////////
// if (search) {
